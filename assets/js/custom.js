...
(function ($) {
                            ...
                            <div class="box-content w-100 d-flex align-items-center">
                                <div class="prev-arrow">
                                    <div class="container-inner">
                                        ...
                                        <svg class="circle circle-below" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            ...
                            <div class="box-content w-100 d-flex align-items-center justify-content-end">
                                ...
                                <div class="next-arrow">
                                    <div class="container-inner">
                                        ...
                                        <svg class="circle circle-below" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                             viewBox="0 0 24 24">
                                            <g class="circle-wrap" fill="none" stroke-width="1" stroke-linejoin="round"
                                               stroke-miterlimit="10">
                                                <circle cx="12" cy="12" r="10.5"></circle>
	...
	function contactValidator() {
        ...
        contact_form.validator(); // Initialize validator
            ...
            if (!e.isDefaultPrevented()) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        const messageAlert = "alert-" + response.type;
                        ...
                        // Display the alert in the .messages div
...
const totalItems = brandCarousel ? document.querySelectorAll('.brand-carousel-item').length : 0;
let currentIndex = 0;

if (prevBtn && nextBtn && brandCarousel) {
    ...
    function updateCarousel() {
        ...
        brandCarousel.style.transform = `translateX(${translateX}%)`;
    }
}

document.addEventListener('scroll', function() {
    const scrollUpButton = document.querySelector('.dsn-scroll-up');
    
    if (window.scrollY > 0.01) { // Adjust threshold as needed
        scrollUpButton.classList.add('fixed');
		scrollUpButton.classList.add('text-flip')
    } else {
        scrollUpButton.classList.remove('fixed');
		scrollUpButton.classList.remove('text-flip')
    }
});